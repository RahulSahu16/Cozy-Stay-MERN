        ...
        <div className="bg-[#b5ae9d] p-6 rounded-xl w-[700px] shadow-md">
          ...
          <div className="flex justify-between gap-4 mb-6">
            ...
            <input
              type="text"
              placeholder="City"
              className="flex-1 px-4 py-3 rounded-md bg-[#e0dcd1] text-white focus:outline-none"
            />
            ...
            <input
              type="number"
              placeholder="Guests"
              className="w-32 px-4 py-3 rounded-md bg-[#e0dcd1] text-white focus:outline-none"
            />
          </div>
